using System;
using UnityEngine; //using Windows.Kinect;


public class KingKongGestureListener : MonoBehaviour, KinectGestures.GestureListenerInterface
{
	...
	private KinectGestures.Gestures gesturePublic;
	public void UserDetected(long userId, int userIndex)
	{
		...
		manager.DetectGesture(userId, KinectGestures.Gestures.KKSuper);
		manager.DetectGesture(userId, KinectGestures.Gestures.KPunch);
