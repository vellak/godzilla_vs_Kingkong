   ...
   SubShader {
     ...
     #pragma instancing_options assumeuniformscaling nomatrices nolightprobe nolightmap forwardadd
      ...
      // 2019.3 holes
          ...
          {
              float hole = UNITY_SAMPLE_TEX2D_SAMPLER(_TerrainHolesTexture, _Diffuse, uv).r;
              clip(hole == 0.0f ? -1 : 1);
          }
      #endif
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Terrain_Base349257769"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base349257769"
