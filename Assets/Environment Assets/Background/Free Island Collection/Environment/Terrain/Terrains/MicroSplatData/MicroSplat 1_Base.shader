...
_TerrainNormalmapTexture("InstancedPerPixelNormal", 2D) = "bump" {}
   ...
   SubShader {
      Tags{"RenderPipeline"="LightweightPipeline" "RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "12"}
...
{
   #if !_MICROMESH && !_MICROMESHTERRAIN && !_MICRODIGGERMESH && !_MICROVERTEXMESH
    ...
    MicroSplatLayer DoMicroSplat(inout SurfaceDescriptionInputs IN)
    {
       ...
       float3 worldNormalVertex = IN.WorldSpaceNormal;
        ...
        #if defined(UNITY_INSTANCING_ENABLED) && !_MICROMESH && !_MICROMESHTERRAIN && !_MICRODIGGERMESH && !_MICROVERTEXMESH && !PASSSHADOW
        ...
        #if (defined(UNITY_INSTANCING_ENABLED) || _PERPIXNORMAL) && !_MICROMESH && !_MICROMESHTERRAIN && !_MICRODIGGERMESH && !_MICROVERTEXMESH && !PASSSHADOW      
